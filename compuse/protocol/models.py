...
class ActionKind(StrEnum):
 WAIT="wait"; SCREENSHOT="screenshot"; MOUSE_MOVE="mouse_move"; TYPE="type"; CLICK="click"; DOUBLE_CLICK="double_click"; DRAG="drag"; SCROLL="scroll"; KEYPRESS="keypress"; KEY_COMBO="key_combo"; FOCUS_WINDOW="window.focus"; LAUNCH="application.launch"
...
Action=Annotated[Union[Wait,Screenshot,MouseMove,TypeText,Click,DoubleClick,Drag,Scroll,Keypress,KeyCombo,FocusWindow,ApplicationLaunch],Field(discriminator="kind")]
